...
export default function Btnpricing() {
  const [countOne, setCountOne] = useState(false);
                  ...
                  <tbody data-testid="feature-comparison-table-tbody">
                    ...
                    <tr>
                      <td>
                        ...
                        <p>
                          ...
                          built-in mobile device management (MDM) support for
                          iOS and Android.
                        </p>
                      </td>
                      <td data-product="Free">
                    ...
                    <tr>
                      <td>
                        ...
                        <p>
                          ...
                          depends on like Slack, Google Drive, Salesforce,
                          Dropbox and more directly into your Trello boards.
                          (Note: Some Power-Ups by our partners require an
                    ...
                    <tr>
                      <td>
                        ...
                        <p>
                          Plan your project, stay on top of every sprint, and
                          see how all of the moving parts fit together over time
                          with Timeline.{" "}
                        </p>
                        <p>
                          <a href="/views" data-testid="4SnauK4G54Ay28XREzdnWY">
                    ...
                    <tr>
                      <td>
                        ...
                        <p>
                          See your projects and tasks across Workspaces and
                          boards in a spreadsheet-style list that can be sorted
                          and filtered to drill down to exactly the cards you
                          need to see.
                        </p>
                        <p>
                          <a href="/views" data-testid="4SnauK4G54Ay28XREzdnWY">
                    ...
                    <tr>
                      <td>
                        ...
                        <p>
                          ...
                          checklist items so you can see what lies ahead for
                          your project and stay on top of today’s to-dos.
                        </p>
                        <p>
                          <a href="/views" data-testid="4SnauK4G54Ay28XREzdnWY">
                            Learn more
                    ...
                    <tr>
                      <td>
                        ...
                        <p>
                          ...
                          product distribution points by adding locations to
                          your cards and visualizing them geographically on a
                          map.
                        </p>
                        <p>
                          <a href="/views" data-testid="4SnauK4G54Ay28XREzdnWY">
                    ...
                    <tr>
                      <td>
                        ...
                        <p>
                          Customers with Premium or Enterprise get priority
                          email support, meaning we’ll make sure your questions
                          get answered within one business day.
                        </p>
                      </td>
                      <td data-product="Free">
                        <img src={tick} />
          ...
          <div className="cont-Security-right">
            ...
            <ul>
              ...
              <div className="caption-text-security">
                Atlassian Access is a separate subscription that your company
                can enable
        ...
        <div className="footer-down-pricing-page">
          <div className="container-3">
            <div className="footer-down">
              ...
              <div className="obj-4-footer-down">
